...
int main() {
     ...
     unsigned char message[] = "messages dly DECODIROVANIYA";
     ...
     std::cout << "Îðèãèíàëüíîå ñîîáùåíèå:  ";
     ...
     std::cout << std::endl << "Çàêîäèðîâàíî:   ";
     ...
     std::cout << std::endl << "Ðàñøèôðîâàíî:   ";

     for (int i = 0; i < decoded.size(); i++) {
         std::cout << decoded[i] << " ";
     }

     std::cout << std::endl << "Ñîîáùåíèå ïîñëå ðàñøèôðîâêè:   ";
